...
<html>
    <head>
        ...
        <?php echo "<meta http-equiv=\"refresh\" content=\"60;url=score.php?evento={$eventoid}\">"; ?>
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                <div class="widget-header">
                                    <h2><strong>Evento: </strong> <?php echo $chall->getEvento() ?></h2>
                                        ...
                                        <form class='form-horizontal' role='form'>
                                            <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $dados = new Read;
                                                    $dados->FullRead("SELECT usuario.username, score_total.score FROM score_total, usuario WHERE usuario.id = score_total.usuario_id and score_total.evento_id= :e ORDER BY score_total.score DESC, score_total.datahora ASC","e={$eventoid}");
                                                    $x = 0;
                                                    foreach ($dados->getResult() as $value) {
                                                        $x = $x + 1;
                                                        echo "<tr>";
                                                        echo "<td><center>{$x}</center></td>";
                                                        echo "<td><center>{$value['username']}</center></td>";
                                                        echo "<td><center></center></td>";
                                                        echo "<td><center><button type=\"button\" class=\"btn btn-success\">{$value['score']}</button></center></td>";
                                                       echo "</tr>";
                                                    }
                                                    ?>
                                                </tbody>

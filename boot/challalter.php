...
$challid = filter_input(INPUT_GET, 'chall', FILTER_VALIDATE_INT);
$dados = new Read;
if (!$login->CheckLogin()):
        ...
        <div id="wrapper">
            ...
            if (isset($getPost)):
                ...
                //$Post = array_map('trim', $setPost);
                 if ($getPost['ativa'] == "Ativado"):
                    $getPost['ativa'] == 1;
                else:
                    $getPost['ativa'] == 0;
                endif;
                $alter = new Update; 
                $alter->IniUpdate("chall", $getPost, "WHERE id = :id", "id={$getPost['id']}");
                if ($alter->getResult()):
                        ...
                        <div class = "col-sm-12 portlets">
                            <div class = "widget">
                                ...
                                <div class = "widget-content padding">
                                    <div id = "basic-form">
                                        <?php 
                                        $dados->FullRead("SELECT * FROM chall where id= :id limit 1", "id={$challid}");
                                        if ($dados->getResult()){
                                        ...
                                        <form role = "form" action = "" method="POST">
                                            <div class = "form-group">
                                                ...
                                                <input type = "text" class = "form-control" id = "nome" name = "nome" value="<?= $nome ?>" autofocus required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <input type = "text" class = "form-control" id = "resposta" name = "resposta" value="<?= $resposta ?>" required>
                                            </div>
                                            <div class = "form-group">
                                                <label for = "link">Link</label>
                                                <input type = "text" class = "form-control" id = "resposta" name = "link" value="<?= $link ?>">
                                            </div>
                                            <div class = "form-group">
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <select class = "form-control" name = "categoria_id">
                                                    <?php
                                                    $dados = new Read;
                                                    $dados->FullRead("SELECT * FROM categoria where id = :id", "id={$categoria_id}");
                                                    foreach ($dados->getResult() as $value) {
                                                        extract($value);
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <select class = "form-control" name = "evento_id">
                                                    <?php
                                                    $dados = new Read;
                                                    $dados->FullRead("SELECT * FROM evento where id = :id","id={$evento_id}");
                                                    foreach ($dados->getResult() as $value) {
                                                        extract($value);
                                                        echo "<option value = \"{$id}\">{$nome}</option>\n";
                                                    }
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <input type = "text" class = "form-control" id = "resposta" name = "autor"   value="<?= $autor ?>" required>
                                            </div>
                                            <div class = "form-group">
                                                <label for = "valor">Valor</label>
                                                <input type = "text" class = "form-control" id = "resposta" name = "valor"  value="<?= $valor ?>" required>
                                            </div>
                                    </div>
                                    <button type = "submit" class = "btn btn-info">Alterar Chall</button>
                                    </form>
                                          <?php
                                             }
                                        }else {
                                            echo "Chall não existe!";
                                        }
                                            ...
                                            <table id = "datatables-1" class = "table table-striped table-bordered" cellspacing = "0" width = "100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($dados->getResult() as $value) {
                                                        ...
                                                        echo "<td><center><button type=\"button\" onclick=\"window.location='challalter.php?chall={$value['id']}'\" class=\"btn btn-info\">Alterar</button></center></td>";
                                                        echo "</tr>";
                                                    }
                                                    ?>
                                                </tbody>

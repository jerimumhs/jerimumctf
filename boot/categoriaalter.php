    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            if (isset($getPost)):
                ...
                $alter = new Update;
                $alter->IniUpdate("categoria", $Post, "WHERE id = :id", "id={$Post['id']}");
                if ($alter->getResult()):
                        ...
                        <div class = "col-sm-12 portlets">
                            <div class = "widget">
                                <div class = "widget-header transparent">
                                    <h2><strong>Cadastrar</strong> Categoria</h2>
                                ...
                                <div class = "widget-content padding">
                                    <div id = "basic-form">
                                        <?php
                                        $dados->FullRead("SELECT * FROM categoria where id= :id limit 1", "id={$categoriaid}");
                                        if ($dados->getResult()) {
                                            ...
                                            <button type = "submit" class = "btn btn-info">Alterar Categoria</button>
                                            </form>
                                        <?php
                                             }
                                        }else {
                            ...
                            <div class = "row">
                                <div class = "col-md-12 portlets">
                                    <div class = "widget">
                                        <div class = "widget-header transparent">
                                            <h2><strong>Cadastrar/Editar/Deletar Categoria</strong></h2>
                                            <div class = "additional-btn">
                                                <a href = "#" class = "hidden reload"><i class = "icon-ccw-1"></i></a>
                                                <a href = "#" class = "widget-toggle"><i class = "icon-down-open-2"></i></a>

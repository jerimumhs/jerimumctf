...
$evento_id = filter_input(INPUT_GET, 'evento', FILTER_VALIDATE_INT);
$dados = new Read;
if (!$login->CheckLogin()):
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="left-footer">
                    <div class="progress progress-xs">
                        ...
                        <a data-toggle="tooltip" title="BootFW" class="btn btn-default md-trigger" data-modal="task-progress"><i class="fa fa-inbox"></i></a>
                    </div>
                </div>
            </div>
            <!-- Left Sidebar End -->		    
            ...
            if (isset($getPost)):
                ...
                $alter = new Update; 
                $alter->IniUpdate("evento", $Post, "WHERE id = :id", "id={$Post['id']}");
                 if ($alter->getResult()):
                    erroBalon("Alterado Com Sucesso", "success");
                else:
                    erroBalon("Não foi possível Alterar", "error");
                endif;
            endif;
            ?>
                        ...
                        <div class = "col-sm-12 portlets">
                            <div class = "widget">
                                <div class = "widget-header transparent">
                                    <h2><strong>Alterar</strong> Evento</h2>
                                ...
                                <div class = "widget-content padding">
                                    <div id = "basic-form">
                                        ...
                                        $dados->FullRead("SELECT * FROM evento where id= :id limit 1", "id={$evento_id}");
                                        if ($dados->getResult()){
                                        ...
                                        <form role = "form" action = "" method="POST">
                                            <div class = "form-group">
                                                ...
                                                <input type = "hidden" class = "form-control" id = "nome" name = "id" value="<?= $id ?>" required>
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <input type = "text" class = "form-control" id = "formatoflag" name = "formatoflag" value="<?= $formatoflag ?>" required>
                                            </div>
                                            <div class = "form-group">
                                                <label for = "datahora">Data Inicio</label>
                                                <input type = "text" class = "form-control" id = "datainicio" name = "datainicio" value="<?= $datainicio ?>" required>
                                            </div>
                                            <div class = "form-group">

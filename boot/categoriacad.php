...
<html>
    ...
    <body class="fixed-left">
        ...
        if (isset($getPost)):
            ...
            $create = new Create;
            $create->IniCreate('categoria', $Post);
            if ($create->getResult()):
                                    ...
                                    <div id = "basic-form">
                                        <form role = "form" action = "" method="POST">
                                            <div class = "form-group">
                                                ...
                                                <input type = "text" class = "form-control" id = "nome" name = "nome" placeholder = "Nome Categoria" autofocus required>
                                            </div>
                                            ...
                                            <table id = "datatables-1" class = "table table-striped table-bordered" cellspacing = "0" width = "100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($dados->getResult() as $value) {
                                                        ...
                                                        echo "<td><center><button type=\"button\" onclick=\"window.location='categoriaalter.php?categoria={$value['id']}'\" class=\"btn btn-info\">Alterar</button></center></td>";
                                                        echo "</tr>";
                                                    }
                                                    ?>
                                                </tbody>

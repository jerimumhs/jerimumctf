    ...
    <body class="fixed-left" onload="">
        ...
        <div id="wrapper">
            ...
            if (isset($getPost)):
                ...
                $read = new Read();
                $read->FullRead("select id,nome from team where hash = :hash", "hash={$Post['hash']}");
                if ($read->getResult()):
                    $alter = new Update;
                    ...
                    if ($alter->getResult()):
                        erroBalon("Você ingressou no team", "success");
                    else:
                        erroBalon("Não foi possivel ingressar no team", "error");
                    endif;
                endif;
                        ...
                        <div class = "col-sm-12 portlets">
                            <div class = "widget">
                                <div class = "widget-header transparent">
                                    <h2><strong>Ingressar em um team</strong></h2>
                                    ...
                                    <div id = "basic-form">
                                        <form role = "form" action = "" method="POST">
                                            <div class = "form-group">
                                                <input type = "text" class = "form-control" id = "nome" name = "hash" placeholder = "Digite o hashteam fornecido pelo capitão" autofocus required>
                                            </div>
                                    </div>
                                    <button type = "submit" class = "btn btn-success">Enter Team</button>
                                    </form>
                                </div>
                            </div>
                        </div>
